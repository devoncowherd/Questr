...
class QuestsViewModel(_application : Application) : AndroidViewModel(_application) {
    ...
    val getByDate : LiveData<List<Quests>>
    val getByAlphabet : LiveData<List<Quests>>
    val getByReverseAlphabet : LiveData<List<Quests>>
    ...
    init {
        ...
        getByDate = questRepository.getByDate
        getByAlphabet = questRepository.getByAlphabet
        getByReverseAlphabet = questRepository.getByReverseAlphabet
    }
